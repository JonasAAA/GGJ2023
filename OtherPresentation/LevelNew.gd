...
#
#export var move_angle_in_deg: float = 10
...
#var directionHistory: PoolIntArray
#var angleInRadHistory: PoolRealArray
...
#	move_angle_in_rad = deg2rad(move_angle_in_deg)
...
#	moveDataHistory = []
#	$Player.initialize()
#	$Root.points.append(get_start_pos())
#	directionHistory.append(DIRECTION.NONE)
#	angleInRadHistory.append(0)
...
#	"Also play appropriate music"
#	if direction == DIRECTION.DOWN:
#		$Root.points.remove(len($Root.points) - 1)
#		directionHistory.remove(len(directionHistory) - 1)
#		angleInRadHistory.remove(len(angleInRadHistory) - 1)
#		can_player_move_back = false
#		return
#	assert(direction == DIRECTION.LEFT || direction == DIRECTION.RIGHT)
#	var new_angle_in_rad
#	if direction == DIRECTION.LEFT:
#		new_angle_in_rad = angleInRadHistory[-1] + move_angle_in_rad
#	if direction == DIRECTION.RIGHT:
#		new_angle_in_rad = angleInRadHistory[-1] - move_angle_in_rad
#	$Root.points.append($Root.points[-1] + Vector2.UP.rotated(new_angle_in_rad) * move_length)
#	directionHistory.append(direction)
#	angleInRadHistory.append(new_angle_in_rad)
#
#func queue_player_move(direction: int) -> void:
#	pass
